...
local MotorFields = {
  {50, 50, COMBO, 1, 1, { "Nej", "Ja"} },
  {50, 127, COMBO, 1, 2, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } },
}
...
local function runMotorConfig(event)
  ...
  fields = MotorFields
  lcd.drawText(40, 20, "Har din modell en motor?", COLOR_THEME_PRIMARY1)
  lcd.drawFilledRectangle(40, 45, 200, 30, TEXT_BGCOLOR)
  fields[2][4]=0
  if fields[1][5] == 1 then
    lcd.drawText(40, 100, "Vilken kanal är den på?", COLOR_THEME_PRIMARY1)
...
local AilFields = {
  {50, 50, COMBO, 1, 2, { "Ingen", "En, eller två med Y-kabel", "Två"} },
  {50, 127, COMBO, 1, 0, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } }, -- Ail1 chan
  {50, 167, COMBO, 1, 4, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "CH8" } }, -- Ail2 chan
}
...
local function runAilConfig(event)
  ...
  lcd.drawText(40, 20, "Har din modell skevroder?", COLOR_THEME_PRIMARY1)
...
local FlapsFields = {
  {50, 50, COMBO, 1, 0, { "Nej", "Ja, på en kanal", "Ja, på två kanaler"} },
  {50, 127, COMBO, 1, 6, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } },
  {50, 167, COMBO, 1, 7, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } },
}
...
local function runFlapsConfig(event)
  ...
  lcd.drawText(40, 20, "Har din modell klaffar?", COLOR_THEME_PRIMARY1)
  lcd.drawFilledRectangle(40, 45, 400, 30, TEXT_BGCOLOR)
  local result = runFieldsPage(event)
  return result
end
...
local TailFields = {
  {50, 50, COMBO, 1, 1, { "En kanal för höjdroder, inget sidroder", "En kanal för höjdroder, en för sidroder", "Två kanaler för höjdroder, en för sidroder", "V-stjärt"} },
  {50, 127, COMBO, 1, 1, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } }, --ele
  {50, 167, COMBO, 1, 3, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } }, --rud
  {50, 207, COMBO, 0, 5, { "KA1", "KA2", "KA3", "KA4", "KA5", "KA6", "KA7", "KA8" } }, --ele2
}
...
local function runTailConfig(event)
  ...
  lcd.drawText(40, 20, "Välj typ av stjärt för din modell", COLOR_THEME_PRIMARY1)
  lcd.drawFilledRectangle(40, 45, 400, 30, TEXT_BGCOLOR)
  local result = runFieldsPage(event)
  return result
end
...
local function drawNextLine(text, text2)
  ...
  lcd.drawText(242, lineIndex, ": KA" .. text2 + 1, COLOR_THEME_PRIMARY1)
...
local function runConfigSummary(event)
  ...
  if(MotorFields[1][5] == 1) then
    drawNextLine("Motorkanal", MotorFields[2][5])
  end
  -- ail
  if(AilFields[1][5] == 1) then
    drawNextLine("Skevroderkanal",AilFields[2][5])
  elseif (AilFields[1][5] == 2) then
    drawNextLine("Höger skevroderkanal",AilFields[2][5])
    drawNextLine("Vänster skevroderkanal",AilFields[3][5])
  end
  -- flaps
  if(FlapsFields[1][5] == 1) then
    drawNextLine("Klaffkanal",FlapsFields[2][5])
  elseif (FlapsFields[1][5] == 2) then
    drawNextLine("Höger klaffkanal",FlapsFields[2][5])
    drawNextLine("Vänster klaffkanal",FlapsFields[3][5])
  end
  -- tail
  if(TailFields[1][5] == 0) then
    drawNextLine("Höjdroderkanal",TailFields[2][5])
  elseif (TailFields[1][5] == 1) then
    drawNextLine("Höjdroderkanal",TailFields[2][5])
    drawNextLine("Sidroderkanal",TailFields[3][5])
  elseif (TailFields[1][5] == 2) then
    drawNextLine("Höger höjdroderkanal",TailFields[2][5])
    drawNextLine("Sidroderkanal",TailFields[3][5])
    drawNextLine("Vänster höjdroderkanal",TailFields[4][5])
  elseif (TailFields[1][5] == 3) then
    drawNextLine("Höger V-stjärtroder", TailFields[2][5])
    drawNextLine("Vänster V-stjärtroder", TailFields[3][5])
  end
  local result = runFieldsPage(event)
...
local function createModel(event)
  ...
  -- Ailerons
  if(AilFields[1][5] == 1) then
    addMix(AilFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(3), "Ske")
  elseif (AilFields[1][5] == 2) then
    addMix(AilFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(3), "SkeH")
    addMix(AilFields[3][5], MIXSRC_FIRST_INPUT+defaultChannel(3), "SkeV", -100)
  end
  -- Flaps
  if(FlapsFields[1][5] == 1) then
  ...
  -- Tail
  if(TailFields[1][5] == 0) then
    addMix(TailFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "Hjd")
  elseif (TailFields[1][5] == 1) then
    addMix(TailFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "Hjd")
    addMix(TailFields[3][5], MIXSRC_FIRST_INPUT+defaultChannel(0), "Sid")
  elseif (TailFields[1][5] == 2) then
    addMix(TailFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "HjdH")
    addMix(TailFields[3][5], MIXSRC_FIRST_INPUT+defaultChannel(0), "Sid")
    addMix(TailFields[4][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "HjdV")
  elseif (TailFields[1][5] == 3) then
    addMix(TailFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "V-HjdH", 50)
    addMix(TailFields[2][5], MIXSRC_FIRST_INPUT+defaultChannel(0), "V-SidH", 50, 1)
    addMix(TailFields[3][5], MIXSRC_FIRST_INPUT+defaultChannel(1), "V-HjdV", 50)
    addMix(TailFields[3][5], MIXSRC_FIRST_INPUT+defaultChannel(0), "V-SidV", -50, 1)
  end
  lcd.drawText(70, 90, "Modellen har skapats!", COLOR_THEME_PRIMARY1)
  lcd.drawText(100, 130, "Tryck RTN för att avsluta", COLOR_THEME_PRIMARY1)
  return 2
end
