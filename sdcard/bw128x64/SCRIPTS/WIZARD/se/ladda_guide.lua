...
local function drawModelChoiceMenu()
  lcd.clear()
  lcd.drawScreenTitle("Välj typ av modell", 0, 0)
    lcd.drawText( 20, 20, "Plan")
    lcd.drawText( 78, 20, "Vinge")
