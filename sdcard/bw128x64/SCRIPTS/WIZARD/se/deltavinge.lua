...
local function applySettings()
  ...
  addMix(elevCH1, MIXSRC_FIRST_INPUT+defaultChannel(1), "D-HjdV", 50)
  addMix(elevCH1, MIXSRC_FIRST_INPUT+defaultChannel(3), "D-SkeV", 50, 1)
  addMix(elevCH2, MIXSRC_FIRST_INPUT+defaultChannel(1), "D-HjdH", 50)
  addMix(elevCH2, MIXSRC_FIRST_INPUT+defaultChannel(3), "D-SkeH", -50, 1)
...
local function drawConfirmationMenu()
  ...
  x, y = drawNextLine(x, y, "Elevon V", elevCH1)
  x, y = drawNextLine(x, y, "Elevon H", elevCH2)
  if rudderMode == 1 then
